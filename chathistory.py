...
if "GOOGLE_API_KEY" not in os.environ:
    os.environ["GOOGLE_API_KEY"] = "AIzaSyAh8sVLC_RL9vxoHsgPD2ybOnEV4I_39uY"
...
class QueryHandler:
    def __init__(self, retriever, tables, pdf_name):
        self.retriever = retriever
        #self.visuals = visuals
        self.tables = tables
        self.pdf_name = pdf_name
        self.llm = ChatGoogleGenerativeAI(model='gemini-1.5-pro', temperature=0.1, top_p=0.95)
    ...
    def save_history_to_json(self):
        ...
        data[self.session_id] = [{"query": q, "answer": a} for q, a in self.conversation_history]
